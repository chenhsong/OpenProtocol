declare namespace iChen.OpenProtocol
{
	...
	export type ValidMessageTypes = CommandMessageTypes | "ControllersList" | "JoinResponse" | "MoldData" | "MoldDataValue" | "CycleData" | "ControllerAction" | "ControllerStatus" | "RequestJobCardsList" | "LoginOperator";
	...
	export interface ISystemMessageMessage extends IMessage
	{
		$type: "SystemMessage";
		message: string;
	}
	...
	export interface IUpdateLanguageMessage extends IMessage
	{
		$type: "UpdateLanguage";
		language: Languages;
	}
	...
	export function createMessage(type: "OperatorInfo", params: { controllerId: number; operatorId: number; name: string; password: string; level: number; }, priority?: number): IOperatorInfoMessage;
